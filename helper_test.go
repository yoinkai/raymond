...
var helperTests = []Test{
	...
	},
	{
		...
		`{{join "foo" "bar" "baz"}}`,
		nil, nil,
		map[string]any{"join": variadicHelper},
		nil,
		`foo,bar,baz`,
	},
	{
	...
	},
	{
		...
		map[string]any{"foo": map[string]string{
			"rick":   "bird person",
			"beth":   "jerry",
			"summer": "morty",
		},
	...
	},
	{
		...
		map[string]any{"foo": []string{"foo", "bar"}},
		nil, nil, nil,
	...
	},
	{
		...
		`{{pluralize error_count "errors" "error"}}`,
		map[string]any{"error_count": "three"},
		nil, nil, nil,
		`error`,
	},
	{
